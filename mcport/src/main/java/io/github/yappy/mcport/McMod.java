...
public class McMod {
    ...
    public static String getHelp(McVersion ver) {
        String verstr = INSTANCES.get(ver).verstr;

        String text;
        try {
            text = Resources.toString(Resources.getResource("%s/help.txt".formatted(verstr)),
                    Charsets.UTF_8);
        } catch (Exception e) {
            throw new RuntimeException(e);
        }
    ...
    public static List<String> getParamNames(McVersion ver) {
        String verstr = INSTANCES.get(ver).verstr;
